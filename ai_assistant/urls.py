...
urlpatterns = [
    ...
    path('continue-conversation/<int:conversation_id>/', views.continue_conversation_view, name='continue_conversation'),
    path('delete-conversation/<int:conversation_id>/', views.delete_conversation_view, name='delete_conversation'),
